    ...
    return Scaffold(
      body: FutureBuilder(
        ...
        future: Supabase.instance.client
            .from('appointments')
            .select('*, profiles:patient_id(*), doctor:doctor_id(full_name)')
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final date = DateFormat('dd MMM yyyy, hh:mm a').format(DateTime.parse(apt['appointment_date']));
              ...
              return Card(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                    ...
                    child: Text(patient['full_name'][0], style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)),
                  ),
